...
Manifold::PointPtr SurfaceOfRevolution<PortalSpace2d>::Portal::getPoint(PointTransportPtr transport) {
	...
	/*if(fabs(fabs(log(getEDist(tt)/getEDist(t))) - transport->getDistance()) >= EPSILON) {
		std::cout << "PortalSpace2d2.cpp fabs(log(getEDist(tt)/getEDist(t))):\t" << fabs(log(getEDist(tt)/getEDist(t))) << std::endl;
		std::cout << "PortalSpace2d2.cpp transport->getDistance():\t" << transport->getDistance() << std::endl;
		std::cout << "fabs(log(getEDist(tt)/getEDist(t))) - transport->getDistance():\t" << fabs(log(getEDist(tt)/getEDist(t))) - transport->getDistance() << std::endl;
	}*/
	assert(fabs(fabs(log(getEDist(tt)/getEDist(t))) - transport->getDistance()) < 0.0001);
	...
	assert(fabs(getSpace()->getGeodesic(testPointOfReference, out)->getVector().norm() - transport->getDistance()) < 0.0001);
	#endif
